 ...
 * Supports use of a bitmap, asset, resource, external file or any other URI.
 *
...
public class ImageSource {
    ...
    /**
     * Disable tiling of the image. This does not apply to preview images which are always loaded
     * as
     * a single bitmap,
     * and tiling cannot be disabled when displaying a region of the source image.
     *
    ...
    /**
     * Enable or disable tiling of the image. This does not apply to preview images which are
     * always
     ...
     * and also a preview image. When displaying a bitmap object, or not using a preview, you do
     * not
     * need to declare
